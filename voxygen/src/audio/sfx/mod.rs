...
//! [SfxEvent](../../../xindeler_common/event/enum.SfxEvent.html) item, with
//! some additional information to allow playback:
...
//! [SfxEvent](../../../xindeler_common/event/enum.SfxEvent.html) documentation
