...
impl Skeleton for QuadrupedMediumSkeleton {
    ...
    #[cfg_attr(
        feature = "be-dyn-lib",
        unsafe(export_name = "quadruped_medium_compute_mats")
    )]
...
pub fn mount_transform(
    ...
    let mount_point = match (body.species, body.body_type) {
        ...
        (Lion, Male) => (0.0, -8.0, 6.0),
        (Lion, Female) => (0.0, -8.0, 6.0),
        (Tarasque, _) => (0.0, -6.0, 6.0),
        (Tiger, _) => (0.0, -8.0, 6.0),
        (Wolf, _) => (0.0, -9.0, 5.0),
        (Frostfang, _) => (0.0, -10.0, 3.5),
        (Mouflon, _) => (0.0, -8.5, 3.5),
        (Catoblepas, _) => (0.0, -8.5, 3.5),
        (Bonerattler, _) => (0.0, -1.0, 5.0),
        (Deer, _) => (0.0, -9.0, 4.0),
        (Hirdrasil, _) => (0.0, -11.0, 3.5),
        (Roshwalr, _) => (0.0, -1.0, 8.0),
        (Donkey, _) => (0.0, -7.0, 5.5),
        (Camel, _) => (0.0, -13.0, 4.5),
        (Zebra, _) => (0.0, -7.0, 4.5),
        (Antelope, _) => (0.0, -8.0, 3.5),
        (Kelpie, _) => (0.0, -6.0, 4.5),
        (Horse, _) => (0.0, -8.0, 4.0),
        (Barghest, _) => (0.0, -8.0, 7.5),
        (Cattle, Male) => (0.0, -3.0, 8.0),
        (Cattle, Female) => (0.0, -2.0, 6.5),
        (Darkhound, _) => (0.0, -2.0, 4.0),
        (Highland, _) => (0.0, -3.0, 8.5),
        (Yak, _) => (0.0, -7.5, 9.0),
        (Panda, _) => (0.0, -10.5, 5.5),
        (Bear, _) => (0.0, -11.0, 5.5),
        (Dreadhorn, _) => (0.0, -1.5, 11.5),
        (Moose, _) => (0.0, -9.0, 7.0),
