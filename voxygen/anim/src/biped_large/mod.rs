    ...
    fn from(body: &'a Body) -> Self {
        ...
        Self {
            ...
            tail: match (body.species, body.body_type) {
                ...
                (Strigoi, _) => (-4.5, -8.0),
                _ => attr_fallback!("BipedLarge", "tail", (0.0, 0.0)),
            },
            ...
            tempo: match (body.species, body.body_type) {
                ...
                (Cursekeeper, _) => 0.8,
                _ => attr_fallback!("BipedLarge", "tempo", 1.0),
            },
            ...
            shl: match (body.species, body.body_type) {
                ...
                _ => attr_fallback!("BipedLarge", "shl", (-4.75, -1.0, 2.5, 1.47, -0.2, 0.0)),
            },
            shr: match (body.species, body.body_type) {
                ...
                _ => attr_fallback!("BipedLarge", "shr", (3.75, -1.5, -0.5, 1.47, 0.3, 0.0)),
            },
            sc: match (body.species, body.body_type) {
                ...
                _ => attr_fallback!("BipedLarge", "sc", (-7.0, 7.0, -10.0, -0.1, 0.0, 0.0)),
            },
            ...
            hhr: match (body.species, body.body_type) {
                ...
                _ => attr_fallback!(
                    "BipedLarge",
                    "hhr",
                    (-6.0, -10.0, 0.0, PI / 2.0, -0.57, 0.0)
                ),
            },
            hc: match (body.species, body.body_type) {
                (Ogre, Male) => (11.5, 9.0, -13.0, -0.57, -PI / 2.0, 1.0),
                _ => attr_fallback!("BipedLarge", "hc", (8.5, 6.0, -12.0, -0.57, -PI / 2.0, 1.0)),
            },
            sthl: match (body.species, body.body_type) {
                ...
                _ => attr_fallback!("BipedLarge", "sthl", (11.0, 5.0, -4.0, 1.27, 0.0, 0.0)),
            },
            sthr: match (body.species, body.body_type) {
                ...
                _ => attr_fallback!("BipedLarge", "sthr", (17.0, 7.5, 2.0, PI / 2.0, 0.8, 0.0)),
            },
