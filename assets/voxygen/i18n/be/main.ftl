...
main-notice =
    Сардэчна запрашаем у альфа-версіі Veloren!
    ...
    - Veloren распаўсюджваецца пад ліцэнзіяй GPL 3. Гэта значыць, што вы вольныя гуляць, мадыфікаваць ды распаўсюджваць гульню, як пажадаеце (пры ўмове, што вашыя мадыфікацыі таксама будуць распаўсюджвацца пад ліцэнзіяй GPL 3).
...
main-login-banned = Вы былі пастаянна заблакаваны па наступнай прычыне: { $reason }
main-login-kicked = Вас выштурхнулі па наступнай прычыне: { $reason }
...
main-singleplayer-map_large_extra_warning = Гэта запатрабуе прыкладна столькі ж рэсурсаў, колькі і стварэнне { $count } светаў з стандартнымі наладамі.
main-singleplayer-map_shape-circle = Круг
main-singleplayer-map_shape-square = Квадрат
main-login-banned_until =
    Вы былі часова забанены з наступнай прычыны: { $reason }
    Да: { $end_date }
main-credits-sound = Гук
