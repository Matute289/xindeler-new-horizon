...
common-species-draugr = Дампір
common-species-danari = Гном
...
common-kind-modular_component = Модульны Кампанент
    .sword = Кампанент Мяча
    .axe = Кампанент Сякеры
    .hammer = Кампанент Молата
    .bow = Кампанент Лука
    .staff = Кампанент Посаха Агню
    .sceptre = Кампанент Скіпетра
...
common-tool-throwable = Кідальны
common-kind-recipegroup = Рэцэпты
common-kind-quest = Квэст
common-kind-lantern = Лямпа
hud-diary-sections-skill_trees-title = Дрэва Навыкаў
hud-diary-sections-abilities-title = Здольнасці
hud-diary-sections-character-title = Персанаж
hud-diary-sections-recipes-title = Рацэпты
hud-battle-mode = Баявы Рэжым
hud-waypoint = Пазнака
