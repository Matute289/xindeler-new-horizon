...
command-pact-desc = (Admin) Manage a Warlock's pact: 'bind <patron> [target]' binds them to a patron, 'sever [target]' breaks the pact (disabling their magic), 'boon <tome|chain|blade|talisman> [target]' sets their pact boon, 'status [target]' reports it
