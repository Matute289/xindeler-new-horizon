...
main-login-2fa-prompt = This account requires a two-factor authentication code. Please enter it below.
main-login-2fa-code_placeholder = 6-digit code
main-login-2fa-wrong_code = Incorrect two-factor authentication code.
main-login-2fa-expired = Your two-factor authentication code expired. Please log in again.
main-login-2fa-locked = This account is locked after too many incorrect codes. Please contact support to unlock it.
main-login-oauth-discord = Continue with Discord
main-login-oauth-google = Continue with Google
main-login-oauth-waiting = Finish signing in with { $provider } in your browser, then come back here.
main-login-oauth-username_prompt = This is your first sign-in with { $provider }. Choose the username you want to play under.
main-login-oauth-username_placeholder = Username
