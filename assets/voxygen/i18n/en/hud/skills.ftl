...
hud-skill_tree-staff_martial = Quarterstaff
...
hud-skill-class-mage-mana_efficiency_title = Efficient Casting
hud-skill-class-mage-mana_efficiency = Streamlined technique reduces the energy cost of spells.
hud-skill-class-mage-mana_recover_title = Arcane Siphon
hud-skill-class-mage-mana_recover = Landing spells draws mana back from the impact, increasing energy gained on hit.
hud-skill-class-mage-mana_flow_title = Mana Flow
hud-skill-class-mage-mana_flow = Mana flows more readily through you, increasing energy regeneration rate.
hud-skill-class-mage-arcane_vigor_title = Arcane Vigor
hud-skill-class-mage-arcane_vigor = Arcane study hardens body as well as mind, increasing maximum health.
hud-skill-class-mage-polyglot_title = Polyglot
hud-skill-class-mage-polyglot = A gift for tongues both mortal and arcane speeds up mastery gain in every magic source, and reduces the gold and time cost of transcribing new spells.
...
hud-skill-unlck_staff_martial_title = Quarterstaff proficiency
hud-skill-unlck_staff_martial = Unlocks the quarterstaff skill tree.{ $SP }
