...
common-abilities-spells-divination-beast_sense = Beast Sense
...
common-abilities-spells-divination-scrying = Scrying
    .desc = Fix your mind on a specific creature and conjure an invisible sensor that follows them wherever they go; see and hear through it while your body stays behind, rooted and blind. A sufficiently warded or powerful mind can resist the link, or shake it off later.
...
common-abilities-spells-abjuration-pass_without_trace = Pass without Trace
    .desc = A hush of drifting shadow spreads from you, swallowing footsteps and scent so nearby allies move unseen and unheard.
common-abilities-spells-abjuration-mooncloak = Mooncloak
    .desc = Pale moonlight wells up around you, draping nearby allies in shifting silver dimness that veils their movements and dulls harmful magic against them.
common-abilities-spells-abjuration-nondetection = Nondetection
    .desc = You weave a screening ward over yourself so that scrying and far-seeing magic slide harmlessly past you. For the duration you cannot be located or perceived by divinatory means.
common-abilities-spells-illusion-magic_aura = Magic Aura
    .desc = By cloaking yourself in a subtle veil, you feed false readings to those who probe you with detection magic. The deception masks your true nature or invents one that was never there.
common-abilities-spells-transmutation-sequester = Sequester
    .desc = You wrap yourself in a veil of stillness, turning yourself unseen and shielding yourself from every form of remote sensing.
