...
common-kind-modular_component = Modulární Součástka
    .sword = Součást Meče
    .axe = Součást Sekery
    .hammer = Součást Kladiva
    .bow = Součást Luku
    .staff = Součást Ohnivé Hole
    .sceptre = Součást Žezla
