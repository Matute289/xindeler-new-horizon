...
main-login-internal_error = Internt fel hos klient. Tips: Spelfiguren kan ha blivit raderad.
...
main-login-invalid_character = Den valda spelfiguren är ogiltig.
...
main-servers-persistence_error = Serverpersistensfel (troligtvis tillgångs-/spelfigurs-datarelaterat): { $raw_error }
