...
common-abilities-bow-fusillade = Ráfaga
    .desc = Coloca en la cuerda y tensa cinco flechas más pequeñas a la vez, escalonándolas para que se suelten una tras otra con un ligero intervalo.
common-abilities-bow-lightning_thorn_stake = Estaca Espinosa Relámpago
    .desc = Dispara una flecha grande y puntiaguda al suelo. Un arco eléctrico golpea a cualquier objetivo que se acerque a la estaca.
common-abilities-bow-lightning_hawkstrike_shot = Golpe de Halcón Relámpago
    .desc = Dispara una flecha de halcón, que resulta más letal al impactar en un punto crítico del objetivo y que es atraída eléctricamente hacia este.
common-abilities-bow-septic_shot = Dardo Séptico
    .desc = Prepara tu próxima flecha para que sea más letal si le has infligido alguna condición a tu objetivo.
...
common-abilities-bow-drench_arrow = Flecha Envenenada
    .desc = Cubre tu próxima flecha con una gota de veneno.
common-abilities-bow-freeze_arrow = Flecha Congelante
    .desc = Moldea un gel helado alrededor de tu próxima flecha.
...
common-abilities-bow-barrage_shot = Lluvia de Flechas
    .desc = Dispara rápidamente varias flechas pequeñas para lanzar una lluvia de flechas sobre tus enemigos con un torrente incesante.
common-abilities-bow-barrage = Lluvia de Flechas
    .desc = Reemplaza tu flecha con punta de caza por una bandolera de flechas más pequeñas para lanzar rápidamente una lluvia de flechas contra tus enemigos.
common-abilities-bow-piercing_gale = Viento Perforador
    .desc = Dispara una flecha giratoria capaz de atravesar a los objetivos para llegar más allá.
common-abilities-bow-death_volley = Descarga Mortal
    .desc = Dispara una ráfaga de flechas al aire en un ángulo fijo, las cuales se dispersarán ampliamente para convertirse en una lluvia mortal.
common-abilities-bow-thorn_stake = Estaca Espinosa
    .desc = Dispara una flecha grande y puntiaguda al suelo. Cualquier objetivo que se acerque a la estaca recibirá daño de las espinas.
common-abilities-bow-burning_thorn_stake = Estaca Espinosa Ardiente
    .desc = Dispara una flecha grande y puntiaguda al suelo. Cualquier objetivo que se acerque a la estaca provocará una explosión de fuego.
common-abilities-bow-freezing_thorn_stake = Estaca Espinosa Helada
    .desc = Dispara una flecha grande y puntiaguda al suelo. Cualquier objetivo que se acerque a la estaca provocará una explosión helada.
common-abilities-bow-poison_thorn_stake = Estaca Espinosa Venenosa
    .desc = Dispara una flecha grande y puntiaguda al suelo. Cualquier objetivo que se acerque a la estaca provocará una explosión venenosa.
common-abilities-staff-napalm_strike = Ataque de Napalm
    .desc = Lanza una ráfaga de napalm que crea una zona de daño de área de efecto.
...
common-abilities-staff-fire_dash = Acelerón de Fuego
...
common-abilities-bow-arrow_shot = Disparo de Flecha
    .desc = Coloca una flecha en la cuerda y suéltala.
common-abilities-bow-broadhead = Punta de Caza
    .desc = Coloca una flecha más pesada y suéltala.
common-abilities-bow-burning_broadhead = Punta de Flecha Ardiente
    .desc = Tu próxima flecha tiene tanta fuerza que el recubrimiento inestable de gotas de fuego explotará al impactar.
...
common-abilities-bow-freezing_broadhead = Punta de Flecha Congelante
    .desc = Al impactar tu flecha, el gel se dispersa y cubre todo lo que hay a su alrededor, dejando a los enemigos vulnerables a ataques aturdidores.
common-abilities-bow-lightning_broadhead = Punta de Flecha Relámpago
    .desc = Tu flecha está cargada de electricidad, lo que hace que sea atraída hacia el blanco.
common-abilities-bow-foothold = Punto de Apoyo
    .desc = Da una patada a un enemigo para saltar hacia atrás mientras le lanzas una flecha.
common-abilities-bow-ardent_hunt = Caza Apasionada
    .desc = Designa un objetivo. Mientras el objetivo esté designado, tus flechas le causarán más daño.
common-abilities-bow-ardent_hunt_clear = Caza Apasionada
    .desc = Deja de designar un objetivo.
common-abilities-bow-storm_chaser = Caza Tormentas
    .desc = Te concentras en tus objetivos, y cuando tus flechas dan en el blanco, tus ataques y movimientos se vuelven más rápidos.
common-abilities-bow-eagle_eye = Ojo de Águila
    .desc = Concentra tu visión para asegurarte de que tus próximos disparos inflijan daño crítico, a costa de parte de tu restauración de energía.
common-abilities-bow-heartseeker = Buscacorazones
    .desc = Prepara una flecha que se alimenta de tu resistencia para buscar el corazón de tu objetivo; se vuelve más letal y te repone la resistencia si impacta.
common-abilities-bow-heartseeker_shot = Buscacorazones
    .desc = Dispara una flecha que busca el corazón; esta se carga con tu resistencia para ser más letal y te repondrá la resistencia.
common-abilities-bow-burning_heartseeker_shot = Buscacorazones Ardiente
    .desc = Dispara una flecha que busca el corazón; esta se carga con tu resistencia para ser más letal, te repone la resistencia y explota al impactar.
common-abilities-bow-poison_heartseeker_shot = Buscacorazones Venenosa
    .desc = Dispara una flecha que busca corazones; esta se carga con tu resistencia para ser más letal, te repone la resistencia y salpica de veneno a los enemigos cercanos.
common-abilities-bow-freezing_heartseeker_shot = Buscacorazones Congelada
    .desc = Dispara una flecha que busca corazones; esta se carga con tu resistencia para ser más letal, te repone la resistencia y cubre de escarcha a los enemigos cercanos.
common-abilities-bow-lightning_heartseeker_shot = Buscacorazones Relámpagueante
    .desc = Dispara una flecha que busca corazones; esta se carga con tu resistencia para ser más letal, te repone la resistencia y es atraída eléctricamente hacia un objetivo.
...
common-abilities-bow-hawkstrike_shot = Golpe de Halcón
    .desc = Dispara una flecha de halcón, que resulta más letal al impactar en un punto crítico del objetivo.
common-abilities-bow-burning_hawkstrike_shot = Golpe de Halcón Ardiente
    .desc = Dispara una flecha de halcón, que resulta más letal al impactar en un punto crítico del objetivo y explota al impactar.
common-abilities-bow-poison_hawkstrike_shot = Golpe de Halcón Venenoso
    .desc = Dispara una flecha de halcón, que resulta más letal al impactar en una zona crítica del objetivo y salpica de veneno a los enemigos cercanos.
common-abilities-bow-freezing_hawkstrike_shot = Golpe de Halcón Congelante
    .desc = Dispara una flecha de halcón, que resulta más letal al impactar en un punto crítico del objetivo y cubre de escarcha a los enemigos cercanos.
