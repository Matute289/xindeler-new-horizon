...
buff-nondetection = No Detección
    .desc = Un velo protector te vuelve inmune a la adivinación y a la magia de rastreo.
buff-magicaura = Aura Mágica
...
buff-detecting = Detectando
    .desc = Estás sintonizado con un sentido mágico.
