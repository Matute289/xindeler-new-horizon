...
main-login-network_wrong_version = Las versiones del servidor y del cliente no coinciden. Sugerencia: Es posible que debas actualizar el cliente del juego o ponerte en contacto con el propietario del servidor para solicitar una actualización.
