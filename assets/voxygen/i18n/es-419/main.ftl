...
main-login-2fa-prompt = Esta cuenta requiere un código de autenticación de dos factores. Ingresalo abajo.
main-login-2fa-code_placeholder = Código de 6 dígitos
main-login-2fa-wrong_code = Código de autenticación de dos factores incorrecto.
main-login-2fa-expired = Tu código de autenticación de dos factores expiró. Iniciá sesión de nuevo.
main-login-2fa-locked = Esta cuenta está bloqueada después de demasiados códigos incorrectos. Contactá a soporte para desbloquearla.
