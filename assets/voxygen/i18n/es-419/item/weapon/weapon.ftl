...
weapon-tome-apprentice_tome = Tomo de Aprendiz
    .desc = Sus márgenes abarrotados con notas frenéticas de líneas de poder de un estudiante.
weapon-tome-the_dark_log = El Registro Oscuro
    .desc = Encuadernado en piel del vacío desollada, acolchado con diamantes de hierro frío alrededor de un único ojo dorado. Quiere ser leído por los malvados, y teme cualquier otra mano.
weapon-tome-the_wicked_darkness = La Oscuridad Perversa
    .desc = Un libro negro encadenado y protegido que corrompe a quien lo toca, y que se vuelve más terrible con cada dueño que le añade algo.
weapon-holy_symbol-initiate_symbol = Símbolo del Iniciado
    .desc = Un pendiente de madera tallada bendecido en un santuario al borde del camino.
weapon-focus-primordial_focus = Foco Primordial
    .desc = Una piedra de río suave usada como canal para espíritus salvajes.
...
weapon-sceptre-amethyst = Cetro de amatista
