...
lantern-seeking_eye = Ojo Buscador
    .desc = Asómate al abismo y esto es lo que te devolverá la mirada.
lantern-tin_torch = Antorcha de Hojalata
    .desc = ¡Una alternativa muy popular entre los aventureros más decididos!
lantern-divers_light = Luz de Buceo
    .desc = Una luz lo suficientemente potente incluso para los más profundos océanos.
lantern-frozen_heart = Corazón Helado
    .desc = Una luz que brilla incluso en los corazones más siniestros.
lantern-luminous_bloom = Flor Luminosa
    .desc = Una misteriosa flor rosa que florece eternamente para iluminar el camino que nos espera.
