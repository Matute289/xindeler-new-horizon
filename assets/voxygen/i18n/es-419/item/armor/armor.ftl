...
armor-misc-ring-test_attunement_ring = Anillo de Prueba de Sintonización
    .desc = Anillo de prueba. Solo otorga su poder mientras estés sintonizado con él.
armor-misc-ring-test_attunement_ring_2 = Anillo de Prueba de Sintonización II
    .desc = Anillo de prueba. Su protección está limitada por sintonización, pero su resistencia de equilibrio no.
...
armor-cultist-necklace = Amuleto de sectario
    .desc = Aún puedes sentir la presencia de un devoramentes en su interior...
