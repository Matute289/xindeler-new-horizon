...
mod tests {
    ...
    enum TestShape {
        Disc(DiscShape, ProceduralContact, &'static str),
        Capsule(CapsuleShape, ProceduralContact, &'static str),
    }
        ...
        for shape in shapes {
            match shape {
                TestShape::Disc(disc, contact, label) => {
                    builder.push_disc(disc, contact, AccommodationTier::Catalog, label)
                },
                TestShape::Capsule(capsule, contact, label) => {
                    builder.push_capsule(capsule, contact, AccommodationTier::Catalog, label)
                },
            }
        }
