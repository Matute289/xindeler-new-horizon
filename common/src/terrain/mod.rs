...
impl TerrainChunkSize {
    ...
    /// ```
    /// use vek::*;
    /// use xindeler_common::terrain::TerrainChunkSize;
    ///
...
/// Whether there is an unobstructed line of sight between two world positions
...
pub fn positions_have_line_of_sight(
    ...
    let dist_sqrd = pos_b.distance_squared(pos_a);
