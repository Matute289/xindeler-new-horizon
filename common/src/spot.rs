...
///    [`xindeler-world::layer::spot::SpotGenerate::generate`] that tells the
///    system where to generate your new spot.
/// 3. Add a new arm to the `match` expression in
///    [`xindeler-world::layer::spot::apply_spots_to`] that tells the generator
